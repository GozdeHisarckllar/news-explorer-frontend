    ...
    <section className="about">
      <article className="about__article">
        ...
        <div className="about__text">
          ...
          <p className="about__info about__info_type_intro">Welcome to News Explorer!<br/><br/>
          ...
          <p className="about__info about__info_type_main">
            ...
            insight into efficient and best practices. Since I like to try coming up with solutions and testing their results, 
